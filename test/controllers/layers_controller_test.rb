...
class LayersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create layer" do
    assert_difference('Layer.count') do
      post layers_url, params: { layer: { infra_project_id: @layer.infra_project_id, json: @layer.json, title: @layer.title, type: @layer.type } }
    end
  ...
  test "should update layer" do
    patch layer_url(@layer), params: { layer: { infra_project_id: @layer.infra_project_id, json: @layer.json, title: @layer.title, type: @layer.type } }
